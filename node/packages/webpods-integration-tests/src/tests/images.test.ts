...
describe('WebPods Image Support', () => {
  ...
  const testPngBase64 = 'iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNkYPhfDwAChwGA60e6kgAAAABJRU5ErkJggg==';
  ...
  describe('Multiple Image Formats', () => {
    it('should support WebP format', async () => {
      ...
      const webpBase64 = 'UklGRhoAAABXRUJQVlA4IA4AAACyAgCdASoBAAEAAABIlpAADcAD+/4=';
