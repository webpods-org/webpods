 ...
 */
export function insert(tableName: string, params: Record<string, unknown>): string {
 ...
 * `;
 */
export function update(tableName: string, params: Record<string, unknown>): string {
